        ...
        <FlatList
          ...
          renderItem={({ item, index }) => (
            <View className="flex items-center h-full">
              ...
              />
              <Text className="absolute text-4xl font-bold text-center shadow-xl shadow-black text-blue-100 ">
                ADMISSION
              </Text>
              {/*Table */}
              <View className=" w-11/12 mt-10 border rounded-xl border-gray-600">
              ...
              <View key={item.id} className="flex mt-4 w-11/12">
                <Text className="text-center text-2xl border-b border-gray-300 text-gray-900 ">
                  {item.header}
                </Text>
