...
const AppStack = () => {
  return (
    ...
    >
      ...
      />
      <Drawer.Screen name="Tast" component={TasteScreen} />
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color }) => (
            <BookOpenIcon size={22} color={color} title={"Courses"} />
          ),
        }}
      />
      <Drawer.Screen
      ...
      <Drawer.Screen
        name="StudentGuide"
        component={StudentGuideScreen}
        options={{
          drawerIcon: ({ color }) => (
            <MapIcon size={22} color={color} title={"StudentGuide"} />
          ),
        }}
      />
      <Drawer.Screen
