  ...
  return (
    <SafeAreaView style={styles.homeScreen}>
      ...
      <ScrollView>
        ...
        {/*Alumni */}
        <View className="items-center my-5 relative bg-slate-100 p-10 shadow-xl shadow-orange-800/30 before:absolute before:top-0 before:left-0 before:right-0 before:bottom-0 before:z-0 before:bg-indigo-400 before:bg-[url('https://cutt.ly/LDGILb2')] before:bg-cover before:bg-center before:opacity-40 before:blur before:content-['']">
          <Image source={{ uri: "https://cutt.ly/LDGILb2" }} />
          <View className="w-11/12">
            <Text className="text-red-600 text-2xl text-center font-semibold mb-3">
              ALUMNI
            </Text>
            <Text className=" text-light ">
              This unversity have 500+ Alumni, who are taking part in solving
              problems of our nation and world wide. As one of the priestigues
              universities in Bangladesh we are commited to make sure that the
              future is certain and sustained.
            </Text>
          </View>
        </View>
      </ScrollView>
