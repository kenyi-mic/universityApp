...
const Courses = () => {
  return (
    <View className="flex flex-1 items-center">
      ...
      <View className="max-w-sm  border-2 py-5 border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <Image
          className="my-5"
        ...
        />
        <Text className="text-sm font-semibold ml-2">MBA</Text>
