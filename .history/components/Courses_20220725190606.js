...
const Courses = ({ data }) => {
  return (
    <View style={styles.container} className="flex flex-1 items-center ">
      ...
      <View className="max-w-sm  border-b-2 my-5 border-blue-600 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
        <Image
          resizeMode="cover"
          className="my-5"
        ...
        <TouchableOpacity activeOpacity={0.8} className="flex-2">
