          ...
          <View>
            ...
            {admissionData.map((item) => (
              <View key={item.id} className="flex ">
                ...
                <Text className="text-normal font-light">{item.body}</Text>
              </View>
            ))}
            {admissioninfo.map((item, i) => (
              <View key={i} className="flex ">
                ...
                <Text className="text-normal font-light text-center">
                  {item.body1}
                </Text>
                <Text className="text-lg font-semibold text-center">
                  {item.subheader2}
                </Text>
                <Text className="text-normal font-light mb-2 text-center">
                  {item.body2}
                </Text>
              </View>
            ))}
