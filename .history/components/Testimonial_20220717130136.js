  ...
  return (
    <View className="bg-slate-900">
      <ImageBackground
        resizeMode="cover"
        style={{}}
        className="w-11/12 h-2"
        source={{ uri: "https://unsplash.com/photos/SjHzF2byBMw" }}
      />
      <View style={styles.container} className="flex flex-1 items-center my-3">
        <View className="w-11/12  rounded-xl my-5 border-2 border-gray-400 pb-5 bg-gray-400 bg-opacity-70 px-3 relative">
          <Text className="text-center text-sm font-extralight my-3">
            {data?.message}
          </Text>
          <Image
            style={styles.image}
