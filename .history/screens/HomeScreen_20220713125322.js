...
import { AcademicCapIcon, SearchIcon } from "react-native-heroicons/outline";
      ...
      <ScrollView>
        ...
        <View className="flex flex-1  justify-center items-center ">
          ...
          <View className="flex flex-1  justify-center items-center my-10">
            ...
            >
              <Text className="text-4xl font-semibold text-white text-center mt-5">
                Why Choose us?
              </Text>
              <View>
                <Text className="text-lg text-white text-center">Best Lab</Text>
                <AcademicCapIcon size={80} color={"white"} />
              </View>
            </View>
          </View>
        </View>
