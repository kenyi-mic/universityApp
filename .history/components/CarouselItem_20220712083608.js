...
const CarouselItem = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      />
      <View className="absolute bottom-10 left-5 w-10">
        <Text className="text-lg font-bold mb-2 text-white shadow-xl shadow-black">
          {truncate(data?.title, 10)}
        </Text>
        <Text className="text-sm text-500 text-white"></Text>
      </View>
    </View>
  );
};
