  ...
  return (
    <SafeAreaView style={styles.homeScreen}>
      ...
      <ScrollView>
        ...
        <View className=" bg-[url('https://images.unsplash.com/photo-1546953304-5d96f43c2e94?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODh8fHN0dWRlbnRzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60')] flex  items-center my-5 bg-blend-darken">
          <Image
          ...
          />
          <Text className="absolute top-10 left-10 text-white bg-blue-200">
            Home
          </Text>
        </View>
      </ScrollView>
