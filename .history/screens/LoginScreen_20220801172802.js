  ...
  return (
    <SafeAreaView>
      <View style={styles.container}>
        <View className="w-full bg-blue-700 h-24 rounded-br-full"></View>
        <View className="flex items-center justify-center ">
          ...
          <Text className="text-2xl text-blue-900 font-semibold my-8">
          ...
          <View className=" w-full">
            <View className="bg-slate-50 w-9/12 py-5 rounded-tr-full rounded-br-full relative">
              <View className="px-4">
                ...
                <View className="flex flex-row  w-9/12 py-2">
                  ...
                  <TextInput
                    className="text-xl font-semibold w-3/4  "
                    placeholder="........."
            ...
            <TouchableOpacity
              activeOpacity={0.99}
              className="items-center justify-center w-14 h-14 rounded-full absolute bg-blue-700 left-2/3 top-12 "
            >
              <View>
        ...
        <View className="bg-blue-50 my-5 w-1/3 rounded-tr-full">
          <TouchableOpacity>
            <Text className="text-lg pl-10 py-2  text-blue-500  font-semibold mb-10">
              Register
            </Text>
          </TouchableOpacity>
        </View>
        <View className="w-full bg-blue-700 h- rounded-tl-full"></View>
        <View className="w-40 bg-red-700 h-56 z-2 rounded-tl-full absolute"></View>
      </View>
    </SafeAreaView>
  );
};
