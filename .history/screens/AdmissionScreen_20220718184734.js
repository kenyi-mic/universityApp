        ...
        <ScrollView>
          <View className="flex items-center">
            ...
            {admissionData.map((item) => (
              <View key={item.id} className="flex flex-1 py-5 w-11/12">
                ...
                <Text className="text-lg font-semibold">{item.subheader1}</Text>
                <Text>{item.subheader2}</Text>
                <Text>{item.body1}</Text>
                <Text>{item.body2}</Text>
              </View>
            ))}
          </View>
        </ScrollView>
