  ...
  return (
    <SafeAreaView>
      <View style={styles.container}>
        ...
        <View className="w-full bg-blue-700 h-40 rounded-tl-full"></View>
        <View className="w-40 bg-blue-700 rounded-tl-full rounded-tr-full h-32 z-2 left-60 bottom-48  "></View>
      </View>
    </SafeAreaView>
  );
};
