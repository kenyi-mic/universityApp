  ...
  return (
    <View className="items-center">
      <View className="w-5/6 border-2 border-gray-300 my-5">
        ...
        <Image resizeMode="contain" source={{uri: 'https://media-exp1.licdn.com/dms/image/C5603AQFCVgA88ynROw/profile-displayphoto-shrink_200_200/0/1582767494951?e=2147483647&v=beta&t=VtnOIEBz5deKrkn33WlI7Q2XELnQvDfv4uMFzmLtulM'}} />
      </View>
    </View>
  );
};
