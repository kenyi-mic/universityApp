          ...
          <View className="flex items-center">
            ...
            {admissionData.map((item) => (
              ...
              >
                ...
                <Text className="text-sm font-extralight">{item.body}</Text>
              </View>
            ))}
            {admissioninfo.map((item, i) => (
              <View
                style={styles.admission1}
                key={i}
                className="flex flex-1 mt-4 w-11/12"
              >
                <Text className="text-center my-2 text-2xl border-b border-gray-300 text-gray-900 ">
                ...
                <Text className="text-sm font-extralight">{item.body1}</Text>
                <Text className="text-sm font-semibold">{item.subheader2}</Text>
