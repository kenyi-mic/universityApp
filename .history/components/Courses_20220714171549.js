...
const Courses = () => {
  return (
    <View className="flex flex-1 items-center">
      ...
      <View className="max-w-sm  border-2 border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <Image
          className="my-5"
        ...
        />
        <Text className="text-sm font-semibold ">MBA</Text>
        <Text className="text-base text-gray-700 font-bold dark:text-gray-400">
          MASTERS OF BUSINESS ADMINSTRATION(MBA)
        </Text>
        <TouchableOpacity className="flex-2">
          <Text className="w-32 h-9 flex items-center left-2/4 my-5 py-2 px-3 text-sm font-medium text-center text-white bg-blue-700  hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Appy Now
          </Text>
        </TouchableOpacity>
      </View>
