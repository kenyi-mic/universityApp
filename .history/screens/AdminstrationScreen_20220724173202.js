        ...
        <ScrollView>
          <View className="flex flex-1 items-center justify-center ">
            ...
            <View style={{ width: width - 20 }} className="my-2">
              <Text className="text-sm p-2 bg-gray-50 w-full m-2 ">
                Adminstration in university of global village is made of the
                following bodies- It indicate the authority of this school
              </Text>
