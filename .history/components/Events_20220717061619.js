  ...
  return (
    <View className="items-center">
      ...
      <View className="my-3 bg-blue-900 hover:bg-red-600 ">
        ...
        />
        <Text className="text-lg font-semibold my-2 ml-2">Event body</Text>

        <View className="flex flex-row ml-2">
          <CalendarIcon size={20} color={"black"} />
          <Text className="text-base justify-center font-semibold mx-2 text-white">
            28 June, 2022
          </Text>
        </View>
        <View className="flex flex-row my-3 ml-2">
