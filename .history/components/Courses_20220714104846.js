...
const Courses = () => {
  return (
    <View
      ...
      className="flex justify-center items-center my-20 border-2 border-gray-100 bg-gray-200 "
    >
      <Text className="text-3xl font-bold text-red-500 text-center my-5 pt-10">
        Courses
      </Text>
      ...
      <View className="py-10">
        ...
        <TouchableOpacity>
          <Text className="text-lg font-semibold text-white  bg-blue-900 w-28 p-2  flex left-2/4  justify-end mt-3">
            Apply Now
          </Text>
        </TouchableOpacity>
      </View>
