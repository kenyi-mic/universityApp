    ...
    <SafeAreaView>
      <View style={styles.container}>
        ...
        <View className="flex items-center justify-center mb-10 ">
          <Image
            style={styles.image}
            source={require("../assets/ugv_logo.png")}
          />
        ...
        <View className="items-end">
          <TouchableOpacity className=" bg-blue-50 my-5 w-2/3 px-4 rounded-tl-full rounded-bl-full ">
        ...
        <View className="w-full bg-blue-800 h-28 rounded-tl-full"></View>
      </View>
    </SafeAreaView>
  );
};
